    ...
    <section id="blog" className="relative z-10 mx-auto max-w-7xl px-6 py-32 md:py-48">
      <div className="mx-auto mb-20 max-w-4xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#A67A3D]">Le Journal Clinique</span>
        </div>
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <a href="/blog" className="group inline-flex items-center gap-3 rounded-full border border-[#E8DFD1] px-8 py-4 text-[10px] font-bold uppercase tracking-widest text-[#241F1A] transition-all hover:bg-[#241F1A] hover:text-white">
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
        {posts.map((post) => (
          <a href={`/blog/${post.slug}`} key={post.id} className="group flex flex-col space-y-8">
            <div className="relative aspect-[16/10] overflow-hidden rounded-[2.5rem] border border-[#E8DFD1] shadow-lg transition-transform duration-500 group-hover:scale-[1.02]">
              <Image 
                src={post.featured_image_url || "/planning-3d.png"} 
                alt={post.title} 
                fill 
              ...
              <div className="absolute top-6 right-6">
                <div className="rounded-full bg-white/40 px-4 py-2 backdrop-blur-xl border border-white/20 text-[8px] font-bold uppercase tracking-widest text-[#241F1A]">
            ...
            <div className="space-y-4 px-2">
              <div className="flex items-center gap-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#A67A3D]">
              ...
              <div className="flex items-center gap-2 pt-2 text-[10px] font-bold uppercase tracking-widest text-[#0891B2] opacity-0 transition-all group-hover:opacity-100 group-hover:translate-x-2">
