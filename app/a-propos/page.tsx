            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-8">
                ...
                <h1 className="font-lora text-[clamp(48px,5vw,72px)] font-medium leading-[0.95] tracking-tight text-[#241F1A]">
                  Dr Flora Jullian <br /> <span className="text-2xl opacity-60">Chirurgien Maxillo-Facial à Mulhouse</span>
                </h1>
                <p className="text-2xl font-lora italic text-[#5A534A] leading-relaxed">
                  &quot;L&apos;excellence chirurgicale en Alsace au service de l&apos;humain, alliant technicité hospitalière et proximité libérale.&quot;
                </p>
                <p className="text-lg text-[#5A534A] leading-relaxed max-w-xl">
                  Praticienne hospitalière au GHRMSA Mulhouse, le Dr Jullian consacre son expertise à la chirurgie du visage, avec une spécialisation en reconstruction et chirurgie orthognathique pour les patients du Sud-Alsace.
                </p>
              </div>
              <div className="relative">
                <div className="aspect-[4/5] rounded-[3rem] overflow-hidden border border-[#E8DFD1] shadow-2xl relative z-10">
                  <Image 
                    ...
                    alt={`Portrait du Dr Flora Jullian, Chirurgien Maxillo-Facial au GHRMSA Mulhouse`}
                    fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-4 space-y-12">
              ...
              <div className="p-10 rounded-[2.5rem] bg-[#241F1A] text-white space-y-6">
                ...
                <p className="text-sm text-white/60 tracking-widest">{floraData.rppsNumber}</p>
            ...
            <div className="lg:col-span-8 space-y-16">
              <div className="prose prose-stone max-w-none text-[#5A534A]">
                ...
                <p className="text-lg leading-relaxed mb-8">
                  Après avoir effectué son internat et son assistanat au sein des Hôpitaux Universitaires de Strasbourg, le Dr Flora Jullian a rejoint le Groupe Hospitalier de la Région de Mulhouse et Sud-Alsace (GHRMSA) en tant que Praticienne Hospitalière.
                </p>
          ...
          <div className="max-w-7xl mx-auto p-12 md:p-24 rounded-[3.5rem] bg-[#FAF6F0] border border-[#E8DFD1] relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-16">
              <div className="space-y-8 max-w-xl text-center md:text-left">
                ...
                <h2 className="font-lora text-4xl md:text-5xl font-medium text-[#241F1A]">Rencontrer le <br /> Dr Flora Jullian</h2>
              ...
              <div className="flex flex-col gap-4 shrink-0 w-full md:w-auto">
                <a href={`tel:${floraContext.contact.phone}`} className="group flex items-center justify-center gap-4 rounded-full bg-[#241F1A] px-10 py-6 text-[11px] font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-[#0891B2]">
