...
export default function ChirurgieMaxilloFacialePage({ context, data }: Props) {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:items-end">
            <div className="lg:col-span-8 space-y-8">
              ...
              <h1 className="font-lora text-[clamp(48px,6vw,84px)] font-medium leading-[0.95] tracking-tight text-[#241F1A]">
                Chirurgie <br /> <span className="opacity-60 italic">Maxillo-Faciale</span>
              </h1>
              <p className="text-xl text-[#5A534A] max-w-2xl leading-relaxed">
                L&apos;excellence de la chirurgie osseuse et reconstructrice du visage. Une expertise pointue pour les traumatismes, les malformations et la reconstruction faciale au sein du plateau technique hospitalier.
              </p>
            </div>
            <div className="lg:col-span-4 pb-4">
              <div className="p-8 rounded-[2.5rem] border border-[#E8DFD1] bg-white shadow-xl shadow-[#C5A065]/5 space-y-6">
                ...
                <a href={`tel:${context.contact.phone}`} className="group flex items-center justify-between w-full rounded-full bg-[#241F1A] px-8 py-5 text-[10px] font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-[#0891B2]">
        ...
        <div className="space-y-20">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-[#5A534A] leading-relaxed">
              Le milieu hospitalier offre un environnement sécurisé avec accès à un plateau technique complet, une réanimation et une surveillance continue 24h/24.
            </p>
          </div>
          <EeatTrustGrid />
        </div>
        ...
        <section className="p-12 md:p-24 rounded-[3.5rem] bg-[#241F1A] text-white overflow-hidden relative shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full max-w-lg">
              <a href={`tel:${context.contact.phone}`} className="flex-1 group flex items-center justify-center gap-4 rounded-full bg-[#C5A065] px-10 py-6 text-[11px] font-black uppercase tracking-[0.2em] text-[#241F1A] transition-all hover:bg-white hover:scale-[1.02]">
