...
export default function OuvertureBouchePage({ context, data }: { context: SiteContext; data: MedicalData }) {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:items-end">
              ...
              <div className="lg:col-span-4 pb-4">
                <div className="p-8 rounded-[2.5rem] border border-[#E8DFD1] bg-white shadow-xl shadow-[#EA4335]/5 space-y-6">
                  ...
                  <a href={`tel:${context.contact.phone}`} className="group flex items-center justify-between w-full rounded-full bg-[#241F1A] px-8 py-5 text-[10px] font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-[#EA4335]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  {[
                    { 
                      ...
                      desc: <>Infection d&apos;une <a href={`/${context.slug}/services/dents-de-sagesse`} className="text-[#0891B2] hover:underline">dent de sagesse</a> (péricoronarite) ou abcès dentaire profond.</> 
                    },
                    { 
                      title: "Origine Articulaire", 
                      desc: <>Dysfonctionnement de l&apos;<a href={`/${context.slug}/services/douleur-machoire`} className="text-[#0891B2] hover:underline">articulation temporo-mandibulaire (ATM)</a>, luxation du ménisque.</> 
                    },
                    { 
                      title: "Traumatisme", 
                      desc: <>Fracture de la mâchoire ou choc direct sur l&apos;articulation (nécessitant une prise en charge en <a href={`/${context.slug}/services/chirurgie-maxillo-faciale`} className="text-[#0891B2] hover:underline">chirurgie maxillo-faciale</a>).</> 
                    },
                    { 
