...
export default function ContactPage({ context, data }: { context: SiteContext; data: MedicalData }) {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:items-end">
              <div className="lg:col-span-8 space-y-8">
                ...
                <p className="text-xl text-[#5A534A] max-w-2xl leading-relaxed">
                  Le cabinet du Dr {data.doctors[0].fullname.split(' ').pop()} est situé au sein du GHRMSA Mulhouse. Notre secrétariat est à votre disposition pour toute demande de rendez-vous ou renseignement.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 rounded-[2.5rem] bg-white border border-[#E8DFD1] space-y-8 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-2xl font-lora text-[#241F1A]">{context.contact.phone}</p>
            ...
            <div className="p-10 rounded-[2.5rem] bg-white border border-[#E8DFD1] space-y-8 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xl font-lora text-[#241F1A] break-all">{context.contact.email}</p>
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="aspect-video w-full rounded-[3rem] bg-[#E8DFD1]/30 border border-[#E8DFD1] relative overflow-hidden group">
                ...
                <div className="absolute bottom-8 left-8 p-6 rounded-2xl bg-white shadow-xl border border-[#E8DFD1] max-w-xs space-y-4">
                    <p className="text-xs font-bold text-[#241F1A] leading-relaxed">{context.contact.address}</p>
                    <a 
                        href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(context.contact.address)}`} 
                        target="_blank" 
