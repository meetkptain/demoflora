...
export default function TraumatismeFacialPage({ context, data }: { context: SiteContext; data: MedicalData }) {
  return (
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-6 py-32 space-y-48">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-lg text-[#5A534A] leading-relaxed">
                Le Dr Flora Jullian assure la prise en charge des traumatismes faciaux au sein du plateau technique hospitalier. Son expertise en <a href={`/${context.slug}/services/chirurgie-maxillo-faciale`} className="text-[#0891B2] hover:underline">chirurgie maxillo-faciale</a> garantit un accès immédiat à l&apos;imagerie (Scanner) et au bloc opératoire si nécessaire.
              </p>
          ...
          <section className="p-12 md:p-24 rounded-[3.5rem] bg-[#241F1A] text-white overflow-hidden relative">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  { title: "Fracture Mandibule", link: `/${context.slug}/services/chirurgie-maxillo-faciale` },
                  { title: "Chirurgie Osseuse", link: `/${context.slug}/services/chirurgie-maxillo-faciale` },
                  { title: "Orthognathie Post-trauma", link: `/${context.slug}/services/orthognathie` },
                  { title: "Suivi Spécialisé", link: `/${context.slug}/contact` }
                ].map((link, i) => (
          ...
          <div className="max-w-3xl mx-auto text-center space-y-8 py-12 border-t border-[#E8DFD1]">
            ...
            <p className="text-[#5A534A] leading-relaxed">
              Pour des informations plus générales sur les interventions chirurgicales du visage, vous pouvez consulter notre page dédiée à la <a href={`/${context.slug}/services/chirurgie-maxillo-faciale`} className="text-[#0891B2] font-medium hover:underline">Chirurgie Maxillo-Faciale globale</a>.
            </p>
          </div>
        </section>
      </div>
