...
export default function GonflementSymptomePage({ context, data }: { context: SiteContext; data: MedicalData }) {
  return (
        ...
        <section className="relative pt-40 pb-24 px-6 z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <h1 className="font-lora text-[clamp(40px,6vw,72px)] font-medium leading-[1] text-[#241F1A]">Gonflement du visage : <br /> <span className="opacity-60 italic">les bons réflexes</span></h1>
              <p className="text-xl text-[#5A534A] max-w-2xl leading-relaxed">
                Un gonflement soudain ou progressif du visage (joue, mâchoire, cou) nécessite une attention particulière pour écarter tout risque infectieux.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-6 py-24 space-y-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-[2.5rem] border border-[#E8DFD1] bg-white space-y-4">
              ...
              <p className="text-xs text-[#5A534A]">Abcès, infection d&apos;une <a href={`/${context.slug}/services/dents-de-sagesse`} className="text-[#0891B2] hover:underline">dent de sagesse</a>. C&apos;est la cause la plus fréquente.</p>
            </div>
            <div className="p-8 rounded-[2.5rem] border border-[#E8DFD1] bg-white space-y-4">
          ...
          <div className="bg-[#FAF6F0] rounded-[3rem] p-12 border border-[#E8DFD1] flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-sm text-[#5A534A] leading-relaxed">
                Le Dr Flora Jullian assure le diagnostic et le traitement des <a href={`/${context.slug}/services/chirurgie-maxillo-faciale`} className="text-[#0891B2] hover:underline">infections maxillo-faciales complexes</a> au sein du plateau technique sécurisé du GHRMSA Mulhouse.
              </p>
            </div>
            <div className="flex-shrink-0">
              <a href={`tel:${context.contact.phone}`} className="flex items-center gap-4 rounded-full bg-[#241F1A] px-10 py-6 text-xs font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-[#0891B2]">
